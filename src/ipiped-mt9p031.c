/* ipiped-mt9p031.c generated by valac 0.12.0, the Vala compiler
...
static gint ipiped_mt9p031_open_sensor (Ipiped_mt9p031* self) {
	...
	if (((AbstcSensor*) self)->capture_fd < 0) {
		fprintf (stderr, "Failed to open sensor\n");
		result = -1;
		return result;
	}
...
static gint ipiped_mt9p031_set_sensor_gain_i (Ipiped_mt9p031* self, gint* capture_fd, gchar* owner_capture_fd, guint32 q10r_gain, guint32 q10g_gain, guint32 q10b_gain) {
	...
	if (((AbstcSensor*) self)->capture_fd < 0) {
		gint _tmp0_;
		_tmp0_ = ipiped_mt9p031_open_sensor (self);
		if (_tmp0_ < 0) {
			result = -1;
			return result;
		}
	...
	_tmp4_ = ioctl (((AbstcSensor*) self)->capture_fd, VIDIOC_S_CTRL, &ctrl);
	if ((-1) == _tmp4_) {
		if (abstc_sensor_debug) {
...
gint ipiped_mt9p031_set_sensor_gain (Ipiped_mt9p031* self, gdouble r_gain, gdouble g_gain, gdouble b_gain, GError** error) {
	...
	_tmp1_ = ipiped_mt9p031_set_sensor_gain_i (self, &((AbstcSensor*) self)->capture_fd, &((AbstcSensor*) self)->owner_capture_fd, q10r_gain, q10g_gain, q10b_gain);
	result = _tmp1_;
	return result;
}
...
gint ipiped_mt9p031_get_sensor_gain (Ipiped_mt9p031* self, GError** error) {
	...
	_tmp1_ = ipiped_mt9p031_get_sensor_gain_i (self, &((AbstcSensor*) self)->capture_fd, &((AbstcSensor*) self)->owner_capture_fd, &q10red_gain, &q10green_gain, &q10blue_gain);
	if (_tmp1_ < 0) {
		result = -1;
		return result;
	}
...
gint ipiped_mt9p031_set_exposure_time (Ipiped_mt9p031* self, gint _exp_time, GError** error) {
	...
	_tmp1_ = ipiped_mt9p031_set_exposure_time_i (self, &((AbstcSensor*) self)->capture_fd, &((AbstcSensor*) self)->owner_capture_fd, (guint32) _exp_time);
	result = _tmp1_;
	return result;
}
...
static gint ipiped_mt9p031_real_get_sensor_data (AbstcSensor* base, struct rraew_sensor* sensor) {
	...
	(*sensor).set_gain = _ipiped_mt9p031_set_sensor_gain_i_set_gain;
	(*sensor).set_gain_target = self;
	(*sensor).get_gain = _ipiped_mt9p031_get_sensor_gain_i_get_gain;
	(*sensor).get_gain_target = self;
	(*sensor).set_exposure = _ipiped_mt9p031_set_exposure_time_i_set_exposure;
	(*sensor).set_exposure_target = self;
	(*sensor).get_exposure = _ipiped_mt9p031_get_exposure_time_i_get_exposure;
