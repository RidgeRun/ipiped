/* ipipe-client.c generated by valac 0.12.0, the Vala compiler
...
struct _ICliIpipeIface {
	...
	gint (*init_aew) (ICliIpipe* self, const gchar* wb, const gchar* ae, const gchar* g, const gchar* meter, gint time, gint fps, gint segment_factor, gint width, gint height, gint center_percentage, GError** error);
...
gint icli_ipipe_init_aew (ICliIpipe* self, const gchar* wb, const gchar* ae, const gchar* g, const gchar* meter, gint time, gint fps, gint segment_factor, gint width, gint height, gint center_percentage, GError** error);
...
static gint icli_ipipe_proxy_init_aew (ICliIpipe* self, const gchar* wb, const gchar* ae, const gchar* g, const gchar* meter, gint time, gint fps, gint segment_factor, gint width, gint height, gint center_percentage, GError** error);
...
gint icli_ipipe_init_aew (ICliIpipe* self, const gchar* wb, const gchar* ae, const gchar* g, const gchar* meter, gint time, gint fps, gint segment_factor, gint width, gint height, gint center_percentage, GError** error) {
	return ICLI_IPIPE_GET_INTERFACE (self)->init_aew (self, wb, ae, g, meter, time, fps, segment_factor, width, height, center_percentage, error);
}
...
static gint icli_ipipe_proxy_init_aew (ICliIpipe* self, const gchar* wb, const gchar* ae, const gchar* g, const gchar* meter, gint time, gint fps, gint segment_factor, gint width, gint height, gint center_percentage, GError** error) {
	...
	g_variant_builder_add_value (&_arguments_builder, g_variant_new_int32 (center_percentage));
	_arguments = g_variant_builder_end (&_arguments_builder);
	g_dbus_message_set_body (_message, _arguments);
	_reply_message = g_dbus_connection_send_message_with_reply_sync (g_dbus_proxy_get_connection ((GDBusProxy *) self), _message, G_DBUS_SEND_MESSAGE_FLAGS_NONE, g_dbus_proxy_get_default_timeout ((GDBusProxy *) self), NULL, NULL, error);
	g_object_unref (_message);
...
static void _dbus_icli_ipipe_init_aew (ICliIpipe* self, GVariant* parameters, GDBusMethodInvocation* invocation) {
	...
	center_percentage = g_variant_get_int32 (_tmp14_);
	g_variant_unref (_tmp14_);
	result = icli_ipipe_init_aew (self, wb, ae, g, meter, time, fps, segment_factor, width, height, center_percentage, &error);
	if (error) {
		g_dbus_method_invocation_return_gerror (invocation, error);
		return;
	}
...
static gint ipipe_cli_cli_run_config_script (IpipeCli* self, gchar** args, int args_length1) {
	...
	if (file != NULL) {
		...
		while (TRUE) {
			...
			_tmp6_ = _tmp5_ = g_strsplit (data, " ", 10);
			s = _tmp6_;
...
static gint ipipe_cli_cli_ini_aew (IpipeCli* self, gchar** args, int args_length1) {
	...
	_tmp5_ = atoi (args[10]);
	center_percentage = _tmp5_;
	_tmp6_ = icli_ipipe_init_aew (self->priv->ipipe, args[1], args[2], args[3], args[4], wait_time, min_fps, segment_factor, width, height, center_percentage, &_inner_error_);
	ret = _tmp6_;
	if (_inner_error_ != NULL) {
...
static void ipipe_cli_initialize_cmd_array (IpipeCli* self) {
	g_return_if_fail (self != NULL);
	command_manager_new_command (self->cmd, "help", _command_manager_command_help_ipipe_command_cmd_func, self->cmd, "help [<command>]", "Displays the help text for all the possible commands or a specific " "command", "");
...
gboolean ipipe_cli_parse_options (IpipeCli* self, gchar** args, int args_length1) {
	...
	ipipe_cli__remaining_args = NULL;
	_tmp0_ = g_option_context_new ("(For Commands HELP: 'ipipe-client help')");
	opt = _tmp0_;
	...
	if (ipipe_cli__cmd_name != NULL) {
		...
		gint _tmp5__length1;
		self->priv->cli_enable = FALSE;
		_tmp1_ = g_strdup ("help");
		_tmp2_ = g_strdup (ipipe_cli__cmd_name);
		_tmp3_ = g_strdup ("\0");
		...
		_tmp5_ = _tmp4_;
		_tmp5__length1 = 3;
		command_manager_command_help (self->cmd, _tmp5_, 3);
...
gboolean ipipe_cli_parse_cmd (IpipeCli* self, gchar** rem_args, int rem_args_length1, GError** error) {
	...
	while (TRUE) {
		...
		_tmp5_ = __readline ("ipipe-client$ ");
		cmd_line = _tmp5_;
		if (cmd_line != NULL) {
			gchar* _tmp6_ = NULL;
			gchar* _tmp7_;
			...
			_tmp6_ = string_strip (cmd_line);
			_tmp7_ = _tmp6_;
			_g_free0 (_tmp7_);
			_tmp9_ = _tmp8_ = g_strsplit (cmd_line, " ", -1);
			args = (_vala_array_free (args, args_length1, (GDestroyNotify) g_free), NULL);
			args = _tmp9_;
			args_length1 = _vala_array_length (_tmp8_);
			_args_size_ = _vala_array_length (_tmp8_);
			if (args[0] != NULL) {
				gchar _tmp11_;
...
gboolean ipipe_cli_parse_config (IpipeCli* self, IpipeCli* cli, GError** error) {
	...
	if (g_strcmp0 (video_processor, "dm365") == 0) {
		...
		self->priv->video_processor_i = _tmp3_;
		_g_object_unref0 (video_processor_obj);
	} else {
	...
	if (g_strcmp0 (sensor, "mt9p031") == 0) {
		cli_mt9p031* _tmp4_ = NULL;
		cli_mt9p031* sensor_obj;
		AbstcCliRegister* _tmp5_;
		_tmp4_ = cli_mt9p031_new (ipipe_cli__debug);
		sensor_obj = _tmp4_;
		...
		_tmp5_ = _g_object_ref0 ((AbstcCliRegister*) sensor_obj);
		_g_object_unref0 (self->priv->sensor_i);
		self->priv->sensor_i = _tmp5_;
		_g_object_unref0 (sensor_obj);
	} else {
...
static gint ipipe_cli_main (gchar** args, int args_length1) {
	...
	_tmp2_ = ipipe_cli_parse_options (cli, args, args_length1);
	if (!_tmp2_) {
		result = -1;
		_g_object_unref0 (cli);
		return result;
	}
	_tmp3_ = ipipe_cli_parse_config (cli, cli, &_inner_error_);
	_tmp4_ = _tmp3_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == G_IO_ERROR) {
			goto __catch8_g_io_error;
	...
	_tmp5_ = ipipe_cli_parse_cmd (cli, ipipe_cli__remaining_args, _vala_array_length (ipipe_cli__remaining_args), &_inner_error_);
	_tmp6_ = _tmp5_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == G_IO_ERROR) {
			goto __catch8_g_io_error;
