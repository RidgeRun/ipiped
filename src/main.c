...
void on_bus_aquired (GDBusConnection* conn) {
	...
	if (file != NULL) {
		...
		while (TRUE) {
			...
			_tmp7_ = _tmp6_ = g_strsplit (data, "=", 2);
			s = _tmp7_;
			s_length1 = _vala_array_length (_tmp6_);
			_s_size_ = _vala_array_length (_tmp6_);
			if (g_strcmp0 (s[0], "processor") == 0) {
				gchar* _tmp8_ = NULL;
				_tmp8_ = string_strip (s[1]);
				_g_free0 (video_processor);
				video_processor = _tmp8_;
			} else {
	...
	if (g_strcmp0 (video_processor, "dm365") == 0) {
		Ipiped_dm365* _tmp10_ = NULL;
		Ipiped_dm365* ipiped_dm365;
		AbstcVideoProcessor* _tmp11_;
		_tmp10_ = ipiped_dm365_new ();
		ipiped_dm365 = _tmp10_;
		_tmp11_ = _g_object_ref0 ((AbstcVideoProcessor*) ipiped_dm365);
		_g_object_unref0 (video_processor_abstract);
		video_processor_abstract = _tmp11_;
	...
	if (g_strcmp0 (sensor, "mt9p031") == 0) {
		Ipiped_mt9p031* _tmp12_ = NULL;
		Ipiped_mt9p031* ipiped_mt9p031;
		AbstcSensor* _tmp13_;
		_tmp12_ = ipiped_mt9p031_new ();
		ipiped_mt9p031 = _tmp12_;
		_tmp13_ = _g_object_ref0 ((AbstcSensor*) ipiped_mt9p031);
		_g_object_unref0 (sensor_abstract);
		sensor_abstract = _tmp13_;
	...
	_tmp14_ = ipipe_new (sensor, video_processor, video_processor_abstract, sensor_abstract);
	ipipe = _tmp14_;
